...
#define STRING_CONFIG_H_AUTHOR "(Vladimir Mateev, Ender-5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MTEEV 2.1.1"
...
//#define LCD_BED_TRAMMING
   ...
   */
  #define BED_TRAMMING_LEVELING_ORDER { RB,LB,RF,LF }
#endif
